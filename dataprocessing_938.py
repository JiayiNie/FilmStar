...
def print_C_profile(sheet,x_list,a_list):
...
def get_F_Dip(sheet):
    ...
    for j in range (4, len(col_wave)):
        if col_wave[j].value  != None:
            ...
            break
    index1 = list_wave.index(910)
    index2 = list_wave.index(970)
    # print(index1,index2)
...
if __name__ == "__main__":
    ...
    print_C_profile(profile_sheet, C_profile_x, C_Profile_a)
